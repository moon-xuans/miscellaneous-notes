...
pring AOP 的源码并不简单，因为它多，所以阅读源码最好就是找到一个分支，追踪下去。
...
首先，先看下 DefaultAdvisorAutoProxyCreator 的继承结构：![1](https://moon-axuan.oss-cn-beijing.aliyuncs.com/axuan/images/typora/1.png)
...
解析 `<aop:aspectj-autoproxy/>` 需要用到 AopNamespaceHandler：![4](C:\Users\DELL\Desktop\4.png)
...
![5 (1)](https://moon-axuan.oss-cn-beijing.aliyuncs.com/axuan/images/typora/5%20(1).png)
...
## 6.闲聊InstantiationAwareBeanPostProcessor
